			...
			<form action="">
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-6">
						<div class="single_product_desc">
							...
							<input type = "text" class = "form-control" id = "pPrice" placeholder="상품 하한가 설정" disabled />
							<br />
				...
				<div align="center">
					<button type="submit" class="btn alazea-btn mt-15" 
							onclick="location.href='${ pageContext.request.contextPath }/views/product/productList.jsp'">삭제하기</button>
					<!-- 입찰자가 한명이라도 생겼을 경우 삭제 버튼 비활성화 -->
...
>>>>>>> refs/remotes/origin/dev_member_bch
