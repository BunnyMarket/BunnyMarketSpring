			...
			<form action="">
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-10">
						<div class="single_product_desc">
							<!-- <h4 class="title">상품 제목</h4> -->
							<input type="text" class="form-control" id="" placeholder="아이디 입력" disabled="disabled"/>
							<br />
						</div>
					</div>
				...
				<div align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="submit" class="btn alazea-btn mt-15" 
							onclick="location.href='${ pageContext.request.contextPath }/views/report/reportDetail.jsp'">수정완료</button>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="submit" class="btn alazea-btn mt-15" 
							onclick="location.href='${ pageContext.request.contextPath }/views/report/reportList.jsp'">삭제하기</button>
				</div>
			</form>
		</div>
	</div>
