              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive" >
                   	<form for ="noticeUpdate" action="${ pageContext.request.contextPath }/admin/notice/noticeUpdate.do" method="post">
					...
					<div class="col-12 col-md-10">
						<div class="single_product_desc">
							<input type="text" class="form-control" name="nTitle" value="${notice.NTitle}" required />
							<br />
						</div>
					</div>
				...
				<div align="center">
					...
					<button type="reset" class="btn alazea-btn mt-15"
						onclick="history.go(-1)">취소하기</button>
				</div>	
                    </form>
                  </div>
                </div>
