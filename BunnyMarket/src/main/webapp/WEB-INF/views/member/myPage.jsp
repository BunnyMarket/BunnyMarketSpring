                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="name" value= ${member.userId} disabled="disabled" style="font-size:18px;">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <button type="button" onclick="reviewGo();" class="btn alazea-btn">후기 작성 완료</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
